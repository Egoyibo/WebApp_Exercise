#Connecting SQL to Python ###Writing Up Our Database to WebApp
#7_02_13 ### 7_10_13
#Joy Ding and Katherine Hennes ###Kate Odell and Jessica Mong
...
def get_student_by_github(github):
    ...
    row = DB.fetchone()
    return row
    #Modified code to return only row (07/10/13)
